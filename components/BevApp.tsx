  ...
  return (
    <div className="space-y-5">
      <div className="rounded-md border border-ink/20 bg-card px-4 py-3">
        <p className="text-sm text-ink-soft">{run.mode === "review" ? "Your draft" : "Your ticket"}</p>
      ...
      {!done && (
        <div className="flex flex-wrap items-center gap-3">
          <button
            ...
            onClick={rush}
            disabled={!script}
            className="rounded border border-stamp bg-card px-4 py-2 font-semibold text-stamp hover:bg-stamp hover:text-card disabled:opacity-50"
          >
            Rush {name}
          </button>
          {run.mode === "review" && (
